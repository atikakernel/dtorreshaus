...
2. Nombra el archivo con el SKU del producto (ejemplo: `JAC01-5.jpeg`)
3. Sube la imagen a la carpeta `public/assets/products/`
4. Formato requerido: `.jpeg`

### Ejemplo

Si tienes el producto con SKU **JAC01-5**, sube la imagen como:
- `public/assets/products/JAC01-5.jpeg`
...
Actualmente hay 20 imágenes de productos:
- **Cocina**: 12 productos (JAC01-5 al JAC01-39)
- **Baño**: 6 productos (JAC01-28 al JAC01-33)
- **Limpieza**: 2 productos (JAC01-34, JAC01-35)
